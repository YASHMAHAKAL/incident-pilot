...
IncidentPilot is an evidence-driven Kubernetes incident investigator. The [project roadmap](.agents/skills/incidentpilot/references/roadmap.md) defines the staged build. This repository includes the Phase 0 foundation, a Phase 1 local observability demo, Phase 2 fault scenarios, [Phase 3 alert-driven incident ingestion](docs/phase-3-incidents.md), a [Phase 4 bounded MCP service](docs/phase-4-mcp.md), a [Phase 5 deterministic evidence engine](docs/phase-5-evidence.md), a [Phase 6 LLM provider boundary](docs/phase-6-llm.md), a [Phase 7 bounded investigator](docs/phase-7-investigator.md), [Phase 8 change intelligence](docs/phase-8-change-intelligence.md), complete [Phase 9 evidence-backed RCA](docs/phase-9-rca.md) coverage for all six v1 scenarios, and a [Phase 10 policy-governed remediation boundary](docs/phase-10-remediation.md). Automatic investigation and GitHub PR creation remain future work.
