...
IncidentPilot is an evidence-driven Kubernetes incident investigator. The [project roadmap](.agents/skills/incidentpilot/references/roadmap.md) defines the staged build. This repository includes the Phase 0 foundation, a Phase 1 local observability demo, Phase 2 fault scenarios, [Phase 3 alert-driven incident ingestion](docs/phase-3-incidents.md), a [Phase 4 read-only MCP investigation service](docs/phase-4-mcp.md), a [Phase 5 deterministic evidence engine](docs/phase-5-evidence.md), a [Phase 6 LLM provider boundary](docs/phase-6-llm.md), a [Phase 7 bounded investigator](docs/phase-7-investigator.md), and [Phase 8 change intelligence](docs/phase-8-change-intelligence.md). Evidence-backed general RCA and remediation are future phases.
